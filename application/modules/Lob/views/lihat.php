                ...
                <div class="card-body d-flex justify-content-center">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input type="text" class="form-control" id="lob" name="lob" placeholder="Masukkan LOB" required data-parsley-required-message="LOB harus terisi.">
                            </div>
                        </div>  
                        <div class="form-group">
    ...
    $(document).ready(function () {
        ...
        $('#tabel_lob').on('click', '.edit', function () {
            ...
            if (image != '') {
                ...
                $('#img_sblm').attr('src', "<?= $url_up.'logo/' ?>"+image);
