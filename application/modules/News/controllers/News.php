...
class News extends CI_Controller {
    ...
    public function __construct() {
        ...
        $array = array(
            'url_uploads' => $url['url_uploads']
        );
        
        $this->session->set_userdata( $array );

        $this->url_up = $this->session->userdata('url_uploads');
    ...
    public function tampil_data_news()
    {
        ...
        foreach ($list as $o) {
            ...
            $tbody[]    = "<div align='center'><a class='' href='".$this->url_up.'news/'.$o['images']."' title='".$o['images']."'><img src='".$this->url_up.'news/'.$o['images']."' width='250px'></a><br>".character_limiter($o['images'],100)."</div>";
