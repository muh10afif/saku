    ...
    <div class="col-md-12">
        ...
        <div class="card shadow">
            <div class="card-header">
                ...
                <?php if ($aksi == '') : ?>
                    <a href="<?= base_url('ajk/klaim') ?>"><button class="btn btn-primary float-right"><i class="ti-arrow-left mr-2"></i>Kembali</button></a>
                <?php elseif ($aksi == 'cetak') : ?>
                    <a href="<?= base_url('ajk/klaim/cetak') ?>"><button class="btn btn-primary float-right"><i class="ti-arrow-left mr-2"></i>Kembali</button></a>
                <?php endif; ?>
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 mt-1">
                                <span>: <span class="tgl_kejadian"></span></span>
                            </div>
                        </div> 
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 mt-1">
                                <span>: <span class="user_input"></span></span>
                            </div>
                        </div> 
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 mt-1">
                                <span>: <span class="cabang_bank"></span></span>
                            </div>
                        </div> 
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="lamabulan" class="col-sm-4 col-form-label">Lama (Bulan)</label>
                            <div class="col-sm-8 mt-1">
                                <span>: <span class="lamabulan"> Bulan</span></span>
                            </div>
                        </div> 
                        <div class="form-group row">
