    ...
    <div class="col-md-12 f_tutup">
        ...
        <div class="card mt-2 shadow">
            <div class="card-body">
                ...
                <table class="table table-bordered table-hover dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;" id="tabel_klaimenquiry" width="100%" cellspacing="0">
...
$(document).ready(function(){
    tabel_klaimenquiry = $('#tabel_klaimenquiry').DataTable({
        "processing" : true,
        "serverSide" : true,
        "order" : [],
        "ajax" : {
            "url" : "<?php echo base_url(); ?>ajk/klaim/ajaxdataenquiry",
            "type" : "POST",
            "data" : function(data){
