    ...
    <div class="col-md-12">
        ...
        <div class="card shadow">
            <div class="card-header">
                <a href="<?= base_url('ajk/klaim/tambah_posting') ?>"><button class="btn btn-primary float-right" id="tambah_data"><i class="ti-plus mr-2"></i>Tambah Data</button></a>
...
$(document).ready(function(){
    tabel_posting = $('#tabel_posting').DataTable({
        ...
        "order" : [],
        "ajax" : {
            "url" : "<?php echo base_url(); ?>ajk/klaim/ajaxdataposting",
            "type" : "POST",
            "data" : function(data){
