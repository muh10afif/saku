    ...
    <div class="col-md-12">
        ...
        <div class="card shadow">
            <div class="card-header">
                <a href="<?= base_url('ajk/klaim/posting') ?>"><button class="btn btn-primary float-right" id="tambah_data"><i class="ti-arrow-left mr-2"></i>Kembali</button></a>
...
$(document).ready(function(){
    ...
    tabel_posting = $('#tabel_posting').DataTable({
        ...
        "order" : [],
        "ajax" : {
            "url" : "<?php echo base_url(); ?>ajk/klaim/ajaxdatatmbhposting",
            "type" : "POST",
            "data" : function(data){
