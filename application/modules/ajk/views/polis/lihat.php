    ...
    <div class="col-md-12">
        ...
        <div class="card mt-2 shadow f_tutup">
            <div class="card-body">
                ...
                <span class="mb-2">Multiple Check : <button class="btn btn-warning ml-2 text-white" id="verifikasi">Verifikasi</button></span> 
            </div>
        </div>
    </div>
</div>
            ...
            <div class="modal-body">
                <div class="d-flex justify-content-center">
                    ...
                    <form action="<?= base_url('ajk/polis/import_excel'); ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group row">
                            <label for="berkas_excel" class="col-sm-4 col-form-label">Upload Excel</label>
                            <div class="col-sm-8">
                                <input class="form-control" type="file" id="berkas_excel" name="berkas_excel">
                            </div>
                        </div>   
                        <a href="<?= base_url().'ajk/polis/download' ?>" id="url_format" download><button type="button" class="btn btn-primary mr-2 ttip" data-toggle="tooltip" data-placement="top" title="Download Format Excel"><i class="ti-download"></i></button></a>
