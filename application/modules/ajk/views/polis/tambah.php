				...
				<form id="collect" method="post">
					<input type="hidden" name="id_polis" id="id_polis" value="">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="idcabangbank" id="idcabangbank" class="select2 validasiform" require>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <select name="id_nasabah" id="id_nasabah" class="select2 validasiform" require>
                        ...
                        <div class="form-group row">
                            <label for="alamat_rumah" class="col-sm-3 col-form-label">Alamat</label>
                            <div class="col-sm-9">
                                <textarea name="alamat_rumah" id="alamat_rumah" class="form-control" rows="2" placeholder="Masukkan Alamat" readonly></textarea>
                            </div>
                        </div> 
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type='text' name="tgl_mulai" id="tgl_mulai" class="form-control datepicker text-center validasiform" readonly placeholder="Pilih Tanggal">
                                    <div class="input-group-append">
                                        <span class="input-group-text">
                                            <span class="ti-calendar"></span>
                                        </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control validasiform" type="text" id="lama_bulan" placeholder="Masukkan Lama Bulan">
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label for="produk" class="col-sm-3 col-form-label">Produk <span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                    <select name="produk" id="produk" class="select2 validasiform" require>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control ribuan1 numeric number_separator validasiform" type="text" id="nilai_pembiayaan" placeholder="Masukkan Nilai Pembiayaan">
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label for="premi" class="col-sm-3 col-form-label">Premi</label>
                            <div class="col-sm-9">
                                <input class="form-control  ribuan1 numeric number_separator validasiform" type="text" id="premi" value="" readonly>
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label for="premi_fax" class="col-sm-3 col-form-label">Premi Fax<span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input class="form-control validasiform" type="text" id="premi_fax" placeholder="Masukkan Premi Fax">
                            </div>
                        </div> 
                        <div class="form-group row">
...
$(document).ready(function(){
        ...
        $('#rate_premi , #nilai_pembiayaan').on("keyup",function(){
            var rate_premi = $('#rate_premi').val();
            var nilai_pembiayaan = parseInt($('#nilai_pembiayaan').val());
            var premi = (rate_premi / 100) * nilai_pembiayaan;
            $('#premi').val(parseInt(premi));
            console.log(premi);
        });
        ...
        if(!validasi.includes(false)){
			...
			if (id_polis == "") { //insert
				$.ajax({
					...
					success: function (data) {
						...
						$('#premi_fax').val('');
						// $('#premi_rek_koran').val('');
                        window.location = "<?php echo base_url(); ?>ajk/polis";
            ...
            swal({
                    title             : "Peringatan",
                    text              : "Gagal Simpan Data, Form Polis kosong",
                    type              : 'warning',
                    showConfirmButton : false,
                    timer             : 1000
                    });
