...
class M_approval extends CI_Model {
    ...
    public function _get_datatables_query_approval()
    {
        ...
        $this->db->select('tsq.id_sppa_quotation, tsq.no_polis, mn.nama as pengguna_tertanggung, s.nama_nasabah as tertanggung, ma.nama_asuransi, ml.lob, tsq.total_akhir_premi, tsq.total_tagihan, ml.lob, cl.cob');
        $this->db->from('tr_sppa_quotation tsq');
        $this->db->join('tr_approve_sppa p', 'p.id_sppa_quotation = t.id_sppa_quotation', 'inner');
        ...
        $this->db->join('relasi_cob_lob rc', 'rc.id_relasi_cob_lob = m.id_relasi_cob_lob', 'left');
