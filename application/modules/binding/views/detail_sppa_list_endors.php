        ...
        <div class="col-sm-8">
            <ol class="breadcrumb float-right">
                ...
                <?php if ($this->uri->segment(4) == 1): ?>
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('binding/list_endors/'.$id_sppa_en.'/'.$this->uri->segment(4)) ?>">List Endorsment</a></li>
                <?php else: ?>
        ...
        <div class="card shadow">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="<?= base_url('binding/list_endors/'.$id_sppa_en.'/'.$uri) ?>"><button class="btn btn-primary float-right" id="kembali"><i class="fas fa-arrow-left mr-2"></i>Kembali</button></a>
                    ...
                    $.ajax({
                        ...
                        success : function (data) {
                            ...
                            swal({
                                ...
                                location.href = "<?= base_url('binding') ?>";
                            });
            ...
            swal({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        data    : {id_sppa:id_sppa,id_sppa_awal:id_sppa_awal},
                        dataType: "JSON",
                        success : function (data) {
