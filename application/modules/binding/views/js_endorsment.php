  ...
  $(document).ready(function () {
    ...
    $('#cobb').change(function () {
      ...
      if (id == 'pilih') {
        ...
        $.ajax({
          type:"GET",
          url:"<?php echo base_url(); ?>business_specifications/showboth/"+id,
          success  : function (data) {
            var hss = JSON.parse(data); 
            var opt = '<option value="pilih">-- Pilih --</option>';
    ...
    $('#lobb').change(function () {
      ...
      $.ajax({
        type      :"GET",
        url       :"<?php echo base_url(); ?>entry_sppa/shwfild/"+id,
        success   : function (data) {
    ...
    $('#simpan_dok').on('click', function () {
        ...
        var form_data = new FormData($('.form_dokumen2')[0]);
    ...
    var tabel_termin = $('#tabel_termin').DataTable({
        ...
        "ajax"              : {
            ...
            "type"  : "POST",
            "data"  : function (data) {
                data.id_sppa    = $('#id_sppa_premi').val();
            },
        },
        "columnDefs"        : [{
            "targets"   : [0,6],
