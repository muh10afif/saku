  ...
  <div class="col-md-9">
    <div class="card shadow">
      ...
      <form id="sendbspc" method="post">
        <div class="card-body">
          <div class="isinya" style="display: none;">
            ...
            <div class="row">
              ...
              <div class="col-md-6 text-right">
                <?php if ($role['create'] == true || $role == null): ?>
                  ...
                  &nbsp;
                  <button type="button" class="btn btn-secondary waves-effect waves-light" id="setpreview" style="margin-bottom: 10px;">
                    Preview
                  </button>
                <?php endif; ?>
              </div>
            </div>
            <table id="sppainput" class="table table-bordered table-hover dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
