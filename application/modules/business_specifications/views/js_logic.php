<script type="text/javascript">
    ...
    function setcolect(daata) {
      $.ajax({
        ...
        success  : function (data) {
          ...
          '<td><a class="text-primary " onclick="addopt()"><i class="fas fa-plus fa-lg mr-2"></i></a></td>'+
          '</tr>';
          $('#istable').html(tempel);
          return true;
        },
        ...
        if (resx.opti != "null" && resx.opti != null) {
          ...
          if (resx.opfl == 1) {
            ...
            $.each(opisi, function (i, val) {
              ...
              cell3.innerHTML = '<a class="text-danger  " onclick="rmvopt(this)"><i class="far fa-trash-alt fa-lg"></i></a>';
            });
            tabx.rows[tabx.rows.length-1].cells[2].innerHTML = '<a class="text-primary " onclick="addopt()"><i class="fas fa-plus fa-lg mr-2"></i></a>';
            $('#caseone').show();
            $('#casetwo').hide();
          }
          $('#condlength').hide();
  ...
  function clearfomisi() {
    var clearset = '<tr>'+
                     '<td>'+
                       '<select class="form-control select2" name="isfild[]" id="isfild" onchange="getvalueopt(this)">'+
                         '<option value="">-- Pilih --</option>'+
                       '</select>'+
                     '</td>'+
                     '<td class="text-center">'+
                       '<a class="btn btn-primary waves-effect waves-light text-white" onclick="storedata(0,this)" data-toggle="modal" data-target="#myModal">'+
                         '<i class="fas fa-pencil-alt mr-1"></i> Input Properties'+
                       '</a>'+
                       '<input type="hidden" name="propasset[]" id="propasset" value="">'+
                     '</td>'+
                     '<td class="text-center">'+
                       '<a style="cursor:pointer" data-toggle="tooltip" data-placement="top" title="Tambah" class="text-primary " onclick="addrow()"><i class="fas fa-plus fa-lg mr-2"></i></a>'+
                     '</td>'+
                    '</tr>';
      ...
      success:function (hasil) {
        ...
        if (data.length > 0) {
          ...
          for (var i = 0; i < data.length; i++) {
            ...
            cell1.innerHTML = '<select class="form-control select2" name="isfild[]" id="isfild" onchange="getvalueopt(this)">'+opp+'</select>';
            // cell2.innerHTML = '<a class="btn btn-primary '+hsisi+' waves-effect waves-light text-white" onclick="storedata(0,this)" data-toggle="modal" data-target="#myModal">'+
            //                     '<i class="fas fa-pencil-alt mr-1"></i> Input Properties'+
            //                   '</a><input type="hidden" name="propasset[]" id="propasset" value='+syx+'>';
            cell2.innerHTML = '<a class="btn btn-primary waves-effect waves-light text-white" onclick="storedata(0,this)" data-toggle="modal" data-target="#myModal">'+
                                '<i class="fas fa-pencil-alt mr-1"></i> Input Properties'+
                              '</a><input type="hidden" name="propasset[]" id="propasset" value='+syx+'>';
            cell3.innerHTML = '<a style="cursor:pointer" data-toggle="tooltip" data-placement="top" title="Hapus" class="text-danger " onclick="removee(this)"><i class="far fa-trash-alt fa-lg"></i></a>';
          }
          tabx.rows[data.length-1].cells[2].innerHTML = '<a style="cursor:pointer" data-toggle="tooltip" data-placement="top" title="Tambah" class="text-primary " onclick="addrow()"><i class="fas fa-plus fa-lg mr-2"></i></a>'+
                                                          '&nbsp;'+
                                                        '<a style="cursor:pointer" data-toggle="tooltip" data-placement="top" title="Hapus" class="text-danger  " onclick="removee(this)"><i class="far fa-trash-alt fa-lg"></i></a>';
  ...
  var arinput = [
    '<select class="form-control select2" name="isfild[]" id="isfild" onchange="getvalueopt(this)"><option value="">-- Pilih --</option></select>',
    '<a class="btn btn-primary waves-effect waves-light text-white" onclick="storedata(0,this)" data-toggle="modal" data-target="#myModal"><i class="fas fa-pencil-alt mr-1"></i> Input Properties</a>',
    '<a style="cursor:pointer" data-toggle="tooltip" data-placement="top" title="Tambah" class="text-primary " onclick="addrow()"><i class="fas fa-plus fa-lg mr-2"></i></a>',
    '<a style="cursor:pointer" data-toggle="tooltip" data-placement="top" title="Hapus" class="text-danger  " onclick="removee(this)"><i class="far fa-trash-alt fa-lg"></i></a>',
    '<input type="hidden" name="propasset[]" id="propasset" value="">'
  ];
  ...
  var aropti = [
    ...
    '<a class="text-primary " onclick="addopt()"><i class="fas fa-plus fa-lg mr-2"></i></a>',
    '<a class="text-danger  " onclick="rmvopt(this)"><i class="far fa-trash-alt fa-lg"></i></a>'
  ];
