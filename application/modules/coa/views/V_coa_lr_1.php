    ...
    <div class="row">
      ...
      <?php echo $this->session->flashdata('pesan'); ?>
        <ul class="nav nav-tabs d-flex justify-content-center" role="tablist">
            <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('coa')?>">
                <span class="d-none d-md-block">NERACA</span><span class="d-block d-md-none"><i class="mdi mdi-home-variant h5"></i></span>
            </a>
            </li>
            <li class="nav-item">
            <a class="nav-link active" href="<?php echo base_url('coa/coa_lr')?>">
                <span class="d-none d-md-block">LABA RUGI</span><span class="d-block d-md-none"><i class="mdi mdi-home-variant h5"></i></span>
            </a>
            </li>
        </ul>
      ...
      <div class="card shadow">
        ...
        <div class="tab-content pt-3">
          ...
          <div class="tab-pane active p-3" id="coa_lr">
            ...
            <div class="row mb-4">
              ...
              <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                ...
                <?php $query = $this->db->query("SELECT * FROM main_coa WHERE no_coa_head ='".$id_head."' order by id_main_coa asc "); ?>
                ...
                <div class="row mb-2">
                  ...
                  <div class="col-md-8 col-lg-8 mt-2">
                    <button type="button" class="btn btn-outline-primary mt-2" data-toggle="modal" data-target="#add-dc<?php echo $j ?>"><i class="fa fa-plus"></i> Tambah</button>
                    <table id="coa_lr<?php echo $j?>" class="table table-hover mt-3 mb-3" style="overflow-x:auto;" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-edit-coa<?php echo $des->id_des_coa ?>" id><i class="fas fa-pencil-alt"></i></button></td>
                        </tr>
                        <!-- Modal -->
                        <div class="modal fade" id="modal-edit-coa<?php echo $des->id_des_coa ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-scrollable|modal-dialog-centered modal-sm|modal-lg|modal-xl" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form method="POST" action="<?php echo base_url()?>coa/update_coalr">
                    ...
                    <div class="modal fade" id="add-dc<?php echo $j ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-scrollable|modal-dialog-centered modal-sm|modal-lg|modal-xl" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="POST" action="<?php echo base_url()?>coa/simpan_dcl">
                              <div class="form-group">
        ...
        <div class="modal fade" id="add-hc" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
          <div class="modal-dialog modal-dialog-scrollable|modal-dialog-centered modal-sm|modal-lg|modal-xl" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="POST" action="<?php echo base_url()?>coa/simpan_hcl">
                  <div class="form-group">
        ...
        <div class="modal fade" id="add-mc" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
          <div class="modal-dialog modal-dialog-scrollable|modal-dialog-centered modal-sm|modal-lg|modal-xl" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="POST" action="<?php echo base_url()?>coa/simpan_mcl">
                  <div class="form-group">
