...
class M_coblob extends CI_Model
{
  ...
  var $kolom_order_user = [null,'m_cob.cob','m_lob.lob'];
  var $kolom_cari_user  = ['LOWER(m_cob.cob)', 'LOWER(m_lob.lob)'];
  ...
  public function _get_data_coblob($value='')
  {
    ...
    $this->db->join('m_tipe_cob', 'm_cob.id_tipe_cob = m_tipe_cob.id_tipe_cob', 'LEFT');
