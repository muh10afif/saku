        ...
        <div class="card shadow">
            ...
            <div class="card-header mb-0">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <a href="<?= base_url() ?>entry_sppa"><button class="btn btn-primary float-right"><i class="entry_sppa/cetak_invoice mr-2"></i>Kembali</button></a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane p-3" id="t_invoice" role="tabpanel">
                                ...
                                <div class="alert alert-primary mb-0 text-center" role="alert">
                                    ...
                                    <p><a href="<?= base_url("entry_sppa/cetak_invoice/$id_sppa") ?>" target="_blank"><button type="submit" class="btn btn-warning text-dark">Cetak Invoice</button></a></p>
                                </div>
                            </div>
                        </div>
