...
<script type="text/javascript">
  $(document).ready(function () {
                  ...
                  <div class="form-group row">
                      ...
                      <div class='col-sm-8'>
                        <div class="input-group mb-3">
                          ...
                          <input type="text" class="text-right form-control kalkulasi_tsi_adt kalkulasi`+a+`" id="kalkulasi`+a+`" placeholder="0" readonly>
                        </div>
                      </div>
                  </div>    
              </div>
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                          <input type="text" class="form-control text-right premi_rp_lain nominal_adt t_premi_lain`+a+`"  id="t_premi_lain`+a+`" value="0" readonly>
                      </div>
                  </div> 
              </div>
            </div>
    ...
    $('.simpan_dok').on('click', function () {
        ...
        var form_data = new FormData($('#form_dokumen_edit')[0]);
                ...
                $.ajax({
                    ...
                    success     : function (data) {
                          ...
                          tabel_dok.ajax.reload(null,false);   
                            ...
                            $('#form_dokumen_edit').trigger("reset");
    ...
    // 11-05-2021
    var tabel_termin = $('.tabel_termin_2').DataTable({
        "processing"        : true,
        "order"             : [],
        "ajax"              : {
    ...
    // edit data termin
    $('.tabel_termin_2').on('click', '.edit', function () {
    ...
    // hapus termin
    $('.tabel_termin_2').on('click', '.hapus', function () {
    ...
    $('#simpan_edit').on('click', function () {
      ...
      var id_cob              = $('.cobb').val();
      var id_lob              = $('.lobb').val();
      var nama_sob            = $('.nama_sob_e').val();
      var id_relasi           = $('.id_relasi_e').val();
      var sppa_number         = $('.sppa_number_cd').val();
      var no_polis            = $('.no_polis_e').val();
      var no_invoice          = $('.no_invoice').val();

      var form_detail         = $('#form_detail_edit').serializeArray();

      // console.log(id_sppa_premi)
      // console.log(tsi)
      // console.log(diskon)
      // console.log(total_persen_premi)
      // console.log(total_akhir_premi)
      // console.log(biaya_admin)
      // console.log(total_tagihan)
      // console.log(payment_method)
      // console.log(tahun_pay)
      // console.log(jumlah_cicilan)

      // console.log(id_sob)
      // console.log(id_cob)
      // console.log(id_lob)
      // console.log(nama_sob)
      // console.log(id_relasi)
      // console.log(sppa_number)
      // console.log(no_polis)
      // console.log(no_invoice)

      // console.log($('#form_detail_edit').serializeArray());
      swal({
          title       : 'Konfirmasi',
          text        : 'Yakin akan kirim data',
          type        : 'warning',
