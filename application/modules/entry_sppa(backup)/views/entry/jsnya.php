...
<script type="text/javascript">
  $(document).ready(function () {
      ...
      if (aksi == "baru") {
        ...
        list = 
            ...
            <tr id="list_add_en`+m+`">
                ...
                <td align="center">
                  <span style="cursor:pointer;" data-toggle="tooltip" data-placement="top" title="Edit" class="edit text-primary mr-2" data-id="`+m+`" no_dokumen="`+no_dokumen+`" tgl_bayar="`+tgl_bayar+`" jumlah="`+jumlah+`" cara_bayar="`+cara_bayar+`" tgl_terima="`+tgl_terima+`"><i class="fas fa-pencil-alt fa-lg"></i></span>
                  <span style="cursor:pointer;" data-toggle="tooltip" data-placement="top" title="Hapus" class="remove text-danger" data-id="`+m+`"><i class="far fa-trash-alt fa-lg"></i></span>
                </td>
            </tr>
            `;    
    ...
    $('.tabel_entry').on('click', '.detail', function () {
      ...
      location.href = "<?= base_url() ?>entry_sppa/tampil_detail_sppa/"+id_sppa+"/entry";
    ...
    $('.tabel_entry').on('click', '.edit', function () {
      ...
      location.href = "<?= base_url() ?>entry_sppa/tampil_edit_sppa/"+id_sppa;
          ...
          if (result.value) {
              $.ajax({
                  ...
                  success : function (data) {
                      ...
                      if (data.status == 'semua data sudah ada') {
    ...
    $('#tambah_dokumen').on('click', function () {
        ...
        list = 
            ...
            <tr id="list_add`+a+`">
                ...
                <td align="center"><span style="cursor:pointer;" data-toggle="tooltip" data-placement="top" title="Hapus" class="remove text-danger ttip" data-id="`+a+`"><i class="far fa-trash-alt fa-lg"></i></span></td>
            </tr>
            `;    
