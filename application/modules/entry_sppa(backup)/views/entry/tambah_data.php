...
<div class="col-md-12 f_tambah">

    <div class="card shadow">
    
        <div class="card-header mb-0">
            <div class="row">
                <div class="col-md-4 mt-3 check_deklarasi">
        ...
        <div class="card-body card_deklarasi" style="display: none;">
                ...
                <div class="sel_mop">
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <div class="form-group row">
                            ...
                            <select name="id_insured" id="id_insured" class="select2">
                                ...
                                <?php foreach ($nasabah as $j => $h): 
                                    
                                    $cri = $this->entry_sppa->cari_list_mop($h['id_nasabah'])->num_rows();
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                            <select name="no_reff_mop" id="no_reff_mop" class="select2 cc" disabled>
                                <option value="">Pilih</option>
                    ...
                    <div class="d-flex justify-content-start">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                            <input type="file" class="form-control file_dok" id="excelfile" name="upload_excel" accept=".xls,.xlsx" disabled>
                            </div>
                        </div>
                        </div>
                        <div class="col-md-6 mt-2">
                            <a href="#" id="url_format"><button type="button" class="btn btn-primary mr-2 ttip" id="download" data-toggle="tooltip" data-placement="top" title="Download Format Excel" disabled><i class="ti-download"></i></button></a>
                            <button type="button" id="preview" class="btn btn-warning mr-2 ttip" onclick="preview()" data-toggle="tooltip" data-placement="top" title="Preview" disabled><i class="ti-zoom-in"></i></button>
            ...
            <hr>
            <div class="form-group row float-right mb-0 f_tab">
                <button type="button" class="btn btn-primary  mr-2 simpan_semua" aksi="deklarasi"><i class="fas fa-check mr-2"></i>Simpan</button>
            </div>
                                
        </div>

            <div class="card-body table-responsive card_non_deklarasi">
                ...
                <div class="col-md-12">
                    ...
                    <li class="nav-item">
                        <a class="nav-link link_entry link_t_detail1 disabled" data-toggle="tab" href="#t_detail1" role="tab">
                        <span class="d-none d-md-block">Detail Insured</span><span class="d-block d-md-none"><i class="mdi mdi-account h5"></i></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link link_entry link_t_dok1 disabled" data-toggle="tab" href="#t_dok1" role="tab">
                        <span class="d-none d-md-block">Documents</span><span class="d-block d-md-none"><i class="mdi mdi-email h5"></i></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link link_entry link_t_premi1 disabled" data-toggle="tab" href="#t_premi1" role="tab">
                    ...
                    <li class="nav-item" hidden>
                        <a class="nav-link link_entry link_t_released1 disabled" data-toggle="tab" href="#t_released1" role="tab">
                    ...
                    <div class="tab-pane active p-3" id="t_client_data1" role="tabpanel">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-8">
                                <select name="id_sob" id="sobb" class="select2" required>
                        ...
                        <p class="font-italic text-danger mt-3">*Perubahan Line of Business (LOB) memperngaruhi Form Detail Insured dan Input Rate</p>
                        </div>
                        <!-- <hr>
                        ...
                        <div class="form-group row float-right mb-0">
                            <!-- <div class="row">
                                ...
                                <button type="button" aksi="t_detail1" class="btn btn-warning mr-2 text-dark lanjutkan lanjutkan_client" disabled><i class="fas fa-chevron-right mr-2"></i>Lanjutkan</button>
                                <button type="button" class="btn btn-primary simpan_semua" aksi="" disabled><i class="fas fa-check mr-2"></i>Simpan</button>
                        </div>
                        </form>
                    </div>
                    <div class="tab-pane p-3" id="t_detail1" role="tabpanel">
                        ...
                        <hr>
                        <div class="form-group row float-right mb-0">
                            <button type="button" aksi="t_dok1" class="btn btn-warning mr-2 text-dark lanjutkan"><i class="fas fa-chevron-right mr-2"></i>Lanjutkan</button>
                            <button type="button" class="btn btn-primary mr-2 simpan_semua" aksi=""><i class="fas fa-check mr-2"></i>Simpan</button>
                        </div>
                        </form>
                    </div>
                    <div class="tab-pane p-3" id="t_dok1" role="tabpanel">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <table class="mt-3 table table-striped dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;" id="tabel_dok_entry" width="100%" cellspacing="0">
                    ...
                    <!-- <form action="#" id="form_dokumen">
                        ...
                        <hr>
                        <div class="form-group row float-right mb-0">
                            <button type="button" aksi="t_premi1" class="btn btn-warning mr-2 text-dark lanjutkan"><i class="fas fa-chevron-right mr-2"></i>Lanjutkan</button>
                            <button type="button" class="btn btn-primary simpan_semua" aksi=""><i class="fas fa-check mr-2"></i>Simpan</button>
                        </div>
                    </div>
            ...
            <!-- <div class="card-footer">
                <div class="form-group row float-right mb-0">
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary mr-2"><i class="ti-check-box mr-2"></i>Simpan</button>
            ...
            <div class="modal-content">
                ...
                <form id="form_termin_m" autocomplete="off" class="form-control-line">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary" id="simpan_termin" aksi="baru"><i class="fas fa-check mr-2"></i>Simpan</button>
    ...
    <div class="col-md-12 card_list_dek" style="display: none;">
        <div class="card shadow">
            <div class="card-body">
