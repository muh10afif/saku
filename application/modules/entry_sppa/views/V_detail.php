            ...
            <div class="card-body">
                ...
                <div class="row mb-2">
                    <div class="col-md-12 text-center">
                        <h5>Nomor Polis : <samp><mark> <?= $sppa['no_polis'] ?> </mark></samp></h5>
                    </div>
                </div>
                ...
                <div class="tab-content">
                        ...
                        <?php if ($sppa['punya_ahli_waris']): ?>
                            <div class="f_ahli_waris">
                                ...
                                <?php $i=1; foreach ($ahli_waris as $w) : ?>
                                    <h4>Ahli Waris <?= $w['ahli_waris_ke'] ?> <span class="text-secondary">(<?= strtoupper($w['status']) ?>)</span></h4><hr>
                                    <div class="row">
                                        <div class="col-md-6">
                    ...
                    <div class="tab-pane p-3" id="t_dokumen" role="tabpanel">
                            ...
                            <input type="hidden" id="aksi_dok" name="aksi_dok" value="detail">
