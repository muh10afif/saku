  ...
  <div class="col-md-7">
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <input type="hidden" name="aksi_simpan" id="aksi_simpan" value="tambah">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control text-right" name="total_akhir_premi" id="total_akhir_premi" value="0" readonly>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" class="text-right form-control number_separator numeric" name="biaya_admin" id="biaya_admin" placeholder="0" value="0" onkeyup="hitung_total()">
                                                    </div>
                                                </div>
                                            </div> <hr>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" name="total_tagihan" class="text-right form-control number_separator numeric" placeholder="0" id="total_tagihan" readonly>
                                                    </div>
                                                </div>
                                            </div>
