        ...
        <div class="card shadow">
                        ...
                        <ul class="nav nav-tabs d-flex justify-content-center mt-2" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#profile" role="tab">
                                    <span class="d-none d-md-block">Rincian</span><span class="d-block d-md-none"><i class="mdi mdi-account h5"></i></span>
                                </a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="card-footer">
                <div class="row">
                    ...
                    <button type="button" id="" class="btn btn-danger batal_binding"><i class="ti-na mr-2"></i>Batal</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-12">
        <div class="card shadow">
            <div class="card-header">
                <button class="btn btn-primary float-right" id="tambah_binding"><i class="ti-plus mr-2"></i> Tambah Data</button>
                <h5 id="judul" class="mb-0 mt-1">Binding Slip</h5>
            </div>
            <div class="card-body">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#tambah_binding').on('click', function () {
        ...
        $('.batal_binding').on('click', function () {
            ...
            $('#form_binding').trigger("reset");
            // 

            $('#aksi').val('Tambah');
            $('.hapus-binding').removeAttr('hidden');
            ...
            $('#tambah_binding').attr('hidden', false);
        })
