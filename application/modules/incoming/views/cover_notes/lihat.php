    ...
    <div class="col-md-12 f_tambah" style="display: none;">
        ...
        <div class="card shadow">
            <div class="card-header mb-0">
                <button class="btn btn-light float-right batal_cover_n"><i class="mdi mdi-close mdi-18px"></i></button>
                        ...
                        <ul class="nav nav-tabs d-flex justify-content-center mt-2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#home" role="tab">
                                    <span class="d-none d-md-block">SPPA Master</span><span class="d-block d-md-none"><i class="mdi mdi-home-variant h5"></i></span> 
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#released" role="tab">
                                    <span class="d-none d-md-block">Binding Slip</span><span class="d-block d-md-none"><i class="mdi mdi-settings h5"></i></span>
                                </a>
                            </li>
                        </ul>
            ...
            <div class="card-footer">
                <div class="row">
                    ...
                    <button type="button" id="" class="btn btn-danger batal_cover_n"><i class="ti-na mr-2"></i>Batal</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-12">
        <div class="card shadow">
            <div class="card-header">
                <button class="btn btn-primary float-right" id="tambah_cover_n"><i class="ti-plus mr-2"></i> Tambah Data</button>
                <h5 id="judul" class="mb-0 mt-1">Cover Notes</h5>
            </div>
            <div class="card-body">
                <table class="table table-bordered table-hover dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;" id="tabel_cover_n" width="100%" cellspacing="0">
                    <thead class="thead-light text-center">
                        <tr>
                            <th width="5%">No</th>
                            <th>No SPPA</th>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#tambah_cover_n').on('click', function () {
        ...
        // aksi batal cover_n
        $('.batal_cover_n').on('click', function () {

            $('#form_cover_n').trigger("reset");
            // 

            $('#aksi').val('Tambah');
            $('.hapus-cover_n').removeAttr('hidden');
            ...
            $('#tambah_cover_n').attr('hidden', false);
        })
