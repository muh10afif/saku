                    ...
                    <div class="col-md-12">
                        ...
                        <ul class="nav nav-tabs d-flex justify-content-center mt-2" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#released" role="tab">
                                    <span class="d-none d-md-block">Released</span><span class="d-block d-md-none"><i class="mdi mdi-settings h5"></i></span>
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active p-3" id="home" role="tabpanel">
                                <button class="btn btn-warning text-dark">New Data</button>
                                <button class="btn btn-warning text-dark">Renewal</button>
                                <button class="btn btn-warning text-dark">Endorsment</button>
                                <button class="btn btn-warning text-dark">Slip Endorsment</button><?= br(2) ?>
                            ...
                            <div class="tab-pane p-3" id="released" role="tabpanel">
                                <div class="alert alert-primary mb-0 text-center" role="alert">
                                    <h4 class="alert-heading mt-2 font-18">Mohon periksa dengan seksama seluruh data entrian Anda.</h4>
                                    <p>Setelah Anda menekan tombol "Release", seluruh data akan dicontrol sepenuhnya oleh Kantor Pusat.</p>
                                    <p><button class="btn btn-warning text-dark">Release</button></p>
                                </div>
                            </div>
                        </div>
    ...
    <div class="col-md-12">
        <div class="card shadow">
            <div class="card-header">
                <button class="btn btn-primary float-right" id="tambah_entry"><i class="ti-plus mr-2"></i> Tambah Data</button>
                <h5 id="judul" class="mb-0 mt-1">SPPA Quatitations</h5>
            </div>
            <div class="card-body">
                <table class="table table-bordered table-hover dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;" id="tabel_entry" width="100%" cellspacing="0">
                    <thead class="thead-light text-center">
                        <tr>
                            <th width="5%">No</th>
                            <th>No SPPA</th>
