    ...
    <div class="col-md-12">
        ...
        <div class="card shadow">
            <div class="card-header">
                <a href="<?= base_url('klaim/form_tambah_data') ?>"><button class="btn btn-primary float-right" id="tambah_klaim"><i class="ti-plus mr-2"></i>Tambah Data</button></a>
                ...
                <div class="d-flex justify-content-center">
                    <div class="col-md-8">
                        <div class="form-group row">
                            <label for="no_klaim" class="col-sm-3 col-form-label">No Klaim</label>
                            <div class="col-sm-9">
