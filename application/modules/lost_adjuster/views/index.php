...
<script type="text/javascript">
    ...
    $.ajax({
      ...
      success  : function (data) {
        ...
        var lsd = "<table style='width:100%; text-align: left;'>"+
                    "<tr>"+
                      "<td style='width:30%;'><b>Kode Loss Adjuster</b></td><td>:</td><td>"+hss[0].kode_loss_adjuster+"</td>"+
                    "</tr>"+
                    "<tr>"+
                      "<td style='width:30%;'><b>Nama Loss Adjuster</b></td><td>:</td><td>"+hss[0].nama+"</td>"+
                    "</tr>"+
                    "<tr>"+
                      "<td style='width:30%;'><b>Telpon</b></td><td>:</td><td>"+hss[0].telp+"</td>"+
                    "</tr>"+
                    "<tr>"+
                      "<td style='width:30%;'><b>Negara</b></td><td>:</td><td>"+(hss[0].negara == null?'-':hss[0].negara)+"</td>"+
                    "</tr>"+
                    "<tr>"+
                      "<td style='width:30%;'><b>Provinsi</b></td><td>:</td><td>"+(hss[0].provinsi == null?'-':hss[0].provinsi)+"</td>"+
                    "</tr>"+
                    "<tr>"+
                      "<td style='width:30%;'><b>kabupaten/Kota</b></td><td>:</td><td>"+(hss[0].kota == null?'-':hss[0].kota)+"</td>"+
                    "</tr>"+
                    "<tr>"+
                      "<td style='width:30%;'><b>Kecamatan</b></td><td>:</td><td>"+(hss[0].kecamatan == null?'-':hss[0].kecamatan)+"</td>"+
                    "</tr>"+
                    "<tr>"+
                      "<td style='width:30%;'><b>Kelurahan/Desa</b></td><td>:</td><td>"+(hss[0].desa == null?'-':hss[0].desa)+"</td>"+
                    "</tr>"+
                    "<tr>"+
                      "<td style='width:30%;'><b>Alamat Lengkap<b></td><td>:</td><td>"+(hss[0].alamat == null?'-':hss[0].alamat)+"</td>"+
                    "</tr>"+
                  "</table>";
        swal({
          title             : "Detail Loss Adjuster",
          html              : lsd,
  ...
  function deletedel(id) {
    swal({
      title       : 'Konfirmasi',
      text        : 'Yakin akan Menghapus Data Lost Adjuster',
      type        : 'warning',
      buttonsStyling      : false,
      confirmButtonClass  : "btn btn-primary",
      cancelButtonClass   : "btn btn-warning mr-3",
