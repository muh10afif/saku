...
<div class="row">
    <div class="col-md-12 f_tambah" style="display: none;">
        <div class="card shadow">
            ...
            <button class="btn btn-light float-right batal_sob"><i class="mdi mdi-close mdi-18px"></i></button>
            ...
            <form id="form_sob" autocomplete="off">
                ...
                <div class="card-body d-flex justify-content-center">
                    <div class="col-md-10">
                        <div class="form-group row">
                            <label for="nama_sob" class="col-sm-3 col-form-label text-left">Kode SOB</label>
                            <div class="col-sm-8">
                            <input type="text" class="form-control" name="nama_sob" id="nama_sob" placeholder="Masukkan SOB">
                            </div>
                        </div>  
                        <div class="form-group row">
                            <label for="nama_sob" class="col-sm-3 col-form-label text-left">SOB</label>
                            <div class="col-sm-8">
                            <input type="text" class="form-control" name="nama_sob" id="nama_sob" placeholder="Masukkan SOB">
                            </div>
                        </div>  
                ...
                <div class="card-footer  d-flex justify-content-end">
                    ...
                    <button type="button" class="btn btn-danger mt-1 batal_sob" id="batal_sob">Batal</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="card shadow">
            <div class="card-header">
            <button class="btn btn-primary float-right" id="tambah_sob">Tambah Data</button>
            <h5 id="judul" class="mb-0 mt-1">Master Data SOB</h5>
            </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        // menampilkan list sob
        var tabel_list_sob = $('#tabel_master_sob1').DataTable({
            "processing"        : true,
            "serverSide"        : true,
            "order"             : [],
            "ajax"              : {
