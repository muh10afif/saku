  ...
  var $role;
    ...
    public function entry($value='')
    {
        $data 	= [
            ...
            'list_nasabah' => $this->outgoing->cari_data_karyawan('m_nasabah')->result_array(),
            'role' => $this->role
                ];
    ...
    public function ajaxdata($action)
    {
      ...
      */
      ...
      foreach ($data as $key) {
        ...
        $tbody[] = $key['klaim_nomor_dok'] != null ? $key['klaim_nomor_dok']:'-';
    ...
    public function tampil_data_dokumen()
    {
        ...
        foreach ($list as $o) {
            ...
            $tbody[]    = $o['nama_file'];
            $tbody[]    = $o['size']." "."kb";
            $tbody[]    = "<a href='".base_url()."upload/outgoing/".$o['nama_file']."'><i class='fas fa-file-pdf fa-lg'></i></a>";
            $data[]     = $tbody;
        }
    ...
    public function tampil_data_dokumen2()
    {
        ...
        foreach ($list as $o) {
            ...
            $tbody[]    = 
            '<a href="'.base_url()."upload/outgoing/".$o['nama_file'].'"><i class="fas fa-file-pdf fa-lg" data-toggle="tooltip" title="File"></i></a>&nbsp;&nbsp;
            <i class="far fa-trash-alt fa-lg"  class="text-danger" data-toggle="tooltip" title="Hapus" onclick="deletedok('.$o['id_dokumen_klaim'].')"></i>';
            $data[]     = $tbody;
        }
    ...
    public function getdata()
    {
      ...
      $respon['id_nasabah'] = $data->id_nasabah;
