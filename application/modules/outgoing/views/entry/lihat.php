	...
	<div class="row align-items-center">
		...
		<div class="col-sm-6">
			<ol class="breadcrumb float-right">
				<li class="breadcrumb-item"><a href="<?php //echo base_url() ?>">All COB</a></li>
									...
									<div class="col-md-8">
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												...
												<select name="pc" id="pc" class="select2">
													<option value="">Pilih Insurer</option>
													<?php foreach ($karyawan as $key) { ?>
														<option value="<?php echo $key['id_karyawan']; ?>">
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<div class="form-group row mb-0">
													...
													<select name="insuredid" id="insuredid" class="select2">
														<option id="insuredid" value="">Pilih Insured</option>
														<?php foreach ($list_nasabah as $key): ?>
															<option value="<?= $key['id_nasabah'] ?>"> <?= $key['nama_nasabah'] ?></option>
														<?php endforeach; ?>
													</select>
...
var tabel_doks = '';
    ...
    $(document).ready(function () {
        ...
        $('#tambah_entry').on('click', function (e) {
					e.preventDefault();
            $('.f_tambah').slideToggle('fast', function() {
								$('#id_data_klaim').val('');
                $('#sppaid').val('');
                $('#pc').val(null).trigger('change');
								$('#sppaid').val(null).trigger('change');
                $('#insuredid').val(null).trigger('change');
                $('#keteranganklm').val('');
                $('#kejdan').val('');
                $('#lokasikejadian').val('');
                $('#nilaiklaim').val('');
        ...
        $('#sppaid').on("change",function(){
            ...
            $.ajax({
                ...
                success : function(hasil){
                    ...
                    $('#insuredid2').val(hasil.nama_nasabah);
                    $('#nmnasabah').val(hasil.nama_nasabah).trigger('change');
                    $('#id_nasabah').val(hasil.nama_nasabah);
										$('#insuredid').val(hasil.id_nasabah).trigger('change');
                }
            });
            $.ajax({
