...
class M_pengecualian extends CI_Model {
    ...
    var $kolom_order_pengecualian = [null, 'LOWER(t.nama_asuransi)', 'LOWER(l.lob)', 'CAST(r.premi as VARCHAR)', 'LOWER(s.pengecualian)'];
    var $kolom_cari_pengecualian  = ['LOWER(t.nama_asuransi)', 'LOWER(l.lob)', 'CAST(r.premi as VARCHAR)', 'LOWER(s.pengecualian)'];
