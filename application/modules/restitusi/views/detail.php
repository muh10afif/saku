    ...
    <div class="col-md-12">
        ...
        <div class="card shadow">
            <div class="card-header">
                ...
                <?php if ($aksi == '') : ?>
                    <a href="<?= base_url('restitusi') ?>"><button class="btn btn-primary float-right"><i class="ti-arrow-left mr-2"></i>Kembali</button></a>
                <?php elseif ($aksi == 'cetak') : ?>
                    <a href="<?= base_url('restitusi/cetak') ?>"><button class="btn btn-primary float-right"><i class="ti-arrow-left mr-2"></i>Kembali</button></a>
                <?php endif; ?>
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 mt-1">
                                <span class="t_tgl_restitusi">: 22-04-2021</span>
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Tanggal Pelunasan</label>
                            <div class="col-sm-8 mt-1">
                                <span class="t_pelunasan">: 22-04-2021</span>
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Tanggal Kirim Dokumen</label>
                            <div class="col-sm-8 mt-1">
                                <span class="t_tgl_kirim_dok">: 22-04-2021</span>
                            </div>
                        </div> 
                        <div class="form-group row">
