                ...
                <table class="table table-bordered table-hover dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;" id="tabel_hari_besar" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>OK</td>
                            <td>OK</td>
                            <td align="center"><a href="<?= base_url('polis/detail/1') ?>"><button type="button" class="btn btn-info mr-2"><i class="ti-info"></i></button></a><button type="button" class="btn btn-success mr-2">K</button><button type="button" class="btn btn-success mr-2">R</button></td>
                        </tr>
                    </tbody>
                </table>
            </div>
