...
class M_user extends CI_Model
{
  ...
  {
    $this->db->select('m_user.id_user, m_user.id_karyawan as idkr, m_user.id_level_user as lvus, m_user.flag_table, level_user.*, level_otorisasi.level_otorisasi, m_karyawan.nama_karyawan, m_user.username, m_jabatan.jabatan, m_karyawan.id_jabatan, m_user.id_pengguna_tertanggung, m_user.id_induk_kumpulan, r.ft_induk_kumpulan,  r.induk_kumpulan');
    $this->db->from('m_user');
    ...
    $this->db->join('relasi_induk_kumpulan r', 'm_user.id_induk_kumpulan = r.id', 'LEFT');
