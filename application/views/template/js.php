...
<script src="<?= base_url() ?>assets/tinymce/tinymce.min.js" type="text/javascript"></script>
 ...
 <script src="<?= base_url() ?>assets/html2canvas/html2canvas.js"></script>

 <script src="<?= base_url() ?>assets/template/plugins/magnific-popup/jquery.magnific-popup.min.js"></script>

 <!-- <script src="<?= base_url() ?>assets/signature/js/jquery.ui.touch-punch.min.js"></script>
 <script src="<?= base_url() ?>assets/signature/js/jquery.signature.min.js"></script>

 <script src="<?= base_url() ?>assets/signature_pad/js/signature_pad.umd.js"></script>
 <script src="<?= base_url() ?>assets/signature_pad/js/app.js"></script> -->

 <script src="<?= base_url() ?>assets/signature_jq/jq-signature.min.js"></script>
